...
const BuyOpenEarn = () => {
  ...
  return (
    <motion.nav
      ...
      initial="hidden"
      whileInView="show"
      className="flex w-full justify-between text-white mt-10 sm:p-4 sm:flex-col sm:items-center sm:my-2"
    >

      <div className="w-33 flex flex-col items-center sm:w-full">
        <div className="mt-40 z-10 text-center sm:mt-0">
      ...
      <div className="flex flex-col w-33 sm:w-full items-center relative">
        <div className="nongraCoin sm:-left-[10px] sm:top-[80px] sm:-z-10 sm:opacity-20" />
        <div className="-mt-10 sm:mt-4 sm:w-[250px]">
          <Image
            src={stellar}
            alt="frame"
            width={300}
        ...
        <span className="text-center font-inter sm:mt-2 sm:font-bold mt-4">
