...
const ComingSoon = () => (
 ...
 Ты знал, что при покупке или продаже на нашей декс бирже, 50% от комиссии идет в украинские фонды?  Мы работаем с самыми активными фондами Украины." textStyles="text-center mt-14 text-white" />
